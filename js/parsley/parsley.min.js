...
!function(d){var h=function(a){this.messages={defaultMessage:"This value seems to be invalid.",type:{email:"此内容必须是一个合法的电邮地址。This value should be a valid email.",url:"此内容必须是一个合法的链接。This value should be a valid url.",urlstrict:"此内容必须是一个合法的链接。This value should be a valid url.",number:"此内容必须是一个合法的数字。This value should be a valid number.",digits:"此内容必须是纯数字。This value should be digits.",dateIso:"此内容必须是一个合法的日期。This value should be a valid date (YYYY-MM-DD).",alphanum:"This value should be alphanumeric.",phone:"This value should be a valid phone number."},notnull:"此内容不许留空。This value should not be null.",
notblank:"此内容不许留空。This value should not be blank.",required:"此内容不许留空。This value is required.",regexp:"This value seems to be invalid.",min:"This value should be greater than or equal to %s.",max:"This value should be lower than or equal to %s.",range:"This value should be between %s and %s.",minlength:"内容过短。This value is too short. It should have %s characters or more.",maxlength:"内容过长。This value is too long. It should have %s characters or less.",rangelength:"This value length is invalid. It should be between %s and %s characters long.",
mincheck:"至少选择%s项。You must select at least %s choices.",maxcheck:"至多选择%s项。You must select %s choices or less.",rangecheck:"You must select between %s and %s choices.",equalto:"This value should be the same."};this.init(a)};h.prototype={constructor:h,validators:{notnull:function(a){return 0<a.length},notblank:function(a){return"string"===typeof a&&""!==a.replace(/^\s+/g,"").replace(/\s+$/g,"")},required:function(a){if("object"===typeof a){for(var b in a)if(this.required(a[b]))return!0;return!1}return this.notnull(a)&&
