...
<section id="content">
    ...
    <div class="b-t b-light dker animated fadeInRight">
        <div class="container m-t-xl" >
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="font-thin m-b-lg">您已成功获取网络连接权限。</h3>
...
<footer id="footer">
    <div class="bg-dark lter text-center fadeInUp" >
        <div class="container wrapper">
            <div class="m-t-xl m-b font-thin"> <h3>一个凭据利用我们所有服务。</h3>
                <a href="http://5io2.com/account" target="_blank" class="btn btn-lg btn-dark b-white bg-empty m-sm">了解 “Cheelem帐户”</a>
            </div>
        </div>
    </div>
